...
* [`Doc/reference/INSTALLER_STANDARD.md`](reference/INSTALLER_STANDARD.md) — มาตรฐานกลางระบบติดตั้งซอฟต์แวร์ Windows (Inno Setup 6, Per-User Topology, PrivilegesRequired=lowest, Fail-Closed Pipeline)
...
* [`Doc/archive/WPF_NATIVE_SPEC.md`](archive/WPF_NATIVE_SPEC.md) — ข้อกำหนดโปรเจกต์เนทีฟ C# .NET 6 WPF (ปลดระวางเพื่อรวมศูนย์การพัฒนาสู่ Python Tracker)
...
4. **ตรวจสอบก่อน Commit:** ทุกการเปลี่ยนแปลงโค้ดจะต้องผ่านการทดสอบ regression เสมอ:
   - Python Test Suite: `python -m pytest -v` (ต้องผ่าน 100% ครบ 92 การทดสอบ)
