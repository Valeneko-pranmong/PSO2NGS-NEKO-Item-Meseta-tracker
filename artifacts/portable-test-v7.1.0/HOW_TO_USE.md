...
2. **การตั้งค่าในโปรแกรม:**
   ...
   - โปรแกรมจะตรวจจับไฟล์ Log สดทันที
...
* **Watch List Filter:**
  - คลิกปุ่ม **"Edit Watch List"** เพื่อระบุชื่อไอเท็มที่ต้องการโฟกัส (บรรทัดละ 1 ชื่อ) แล้วกดบันทึก
  - เปิดสวิตช์ **"เปิดใช้ Watch List Filter"** เพื่อกรองแสดงเฉพาะไอเท็มหายากที่คุณสนใจ
* **เริ่มนับใหม่ (Reset):** คลิกปุ่ม **"เริ่มนับใหม่ (Reset)"** เพื่อล้างยอดเงิน เวลา และไอเท็มดรอปเพื่อเริ่มรอบฟาร์มใหม่
...
* **การเข้าร่วมสงคราม:** คลิกปุ่ม **"⚔️ เข้าสู่สงคราม (ARKS War)"** ที่แถบเมนู
